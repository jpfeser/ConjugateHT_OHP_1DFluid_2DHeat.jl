...
const RN_BOIL_DEFAULT = 3e-6; # changes dTsuperheat, bigger RN -> smaller dT (approx. linear)
const FILM_FRACTION_DEFAULT = 0.9; # was 0.3...not sure why
const BOIL_WAITING_TIME_DEFAULT = 1.0; # was 1.0, seems big.
